...
/**
 * Testa as funcionalidades da clase EmprestimoComparatorNomeItem.
 * 
 ...
 *
 */
public class EmprestimoComparatorNomeItemTest {

	/**
	 * Faz testes de comparação entre empréstimos a partir do nome do item
	 * emprestado.
	 */
	@Test
	public void testCompare() {
		EmprestimoComparatorNomeItem comparador = new EmprestimoComparatorNomeItem();
		...
		assertTrue(comparador.compare(emprestimo3, emprestimo1) < 0);

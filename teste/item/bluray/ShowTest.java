...
public class ShowTest
{
	...
	/**
	 * Metodo que testa o comportamento do Construtor quando o nome do Show eh nulo
	 */
	...
	/**
	 * Metodo que testa o comportamento do Construtor quando o nome do Show eh vazio
	 */
	...
	/**
	 * Metodo que testa o comportamento do Construtor quando o preco do Show eh Invalido
	 */
	@Test(expected=IllegalArgumentException.class)
	...
	/**
	 * Metodo que testa o comportamento do Construtor quando a duracao do Show eh Invalida
	 */
	@Test(expected=IllegalArgumentException.class)
	...
	/**
	 * Metodo que testa o comportamento do Construtor quando o numero de faixas do Show eh invalido
	 */
	@Test(expected=IllegalArgumentException.class)
	...
	/**
	 * Metodo que testa o comportamento do Construtor quando o nome do Artista do Show eh nulo
	 */
	@Test(expected=NullPointerException.class)
	...
	/**
	 * Metodo que testa o comportamento do Construtor quando o nome do Artista do Show eh vazio
	 */
	@Test(expected=IllegalArgumentException.class)
	...
	/**
	 * Metodo que testa o comportamento do Construtor quando a classificacao do Show eh nula
	 */
	@Test(expected=NullPointerException.class)
	...
	/**
	 * Metodo que testa o comportamento do Construtor quando a classificacao do Show eh vazia
	 */
	@Test(expected=IllegalArgumentException.class)
	...
	/**
	 * Metodo que testa o comportamento do Construtor quando a classificacao do Show eh invalida
	 */
	@Test(expected=IllegalArgumentException.class)
	...
	/**
	 * Metodo que testa se os getters e setters estao retornando corretamente os atributos desejados
	 */
	@Test
	...
	/**
	 * Metodo que testa o comportamento de setNumDeFaixas (tambem incluidos os comportamentos de risco)
	 */
	@Test
	...
	/**
	 * Metodo que testa os comportamento de setArtista quando eh necessario realizar uma mudanca
	 */
	@Test
	...
	/**
	 * Metodo que testa quando o atributo nao eh nenhum atributo cadastrado no sistema
	 */
	@Test(expected=IllegalArgumentException.class)
	...
	/**
	 * Metodo que testa o comportamento, em relacao a corretudo, de atualizaAtributo
	 */
	@Test
	...
	/**
	 * Metodo que testa o comportamento de atualizaAtributo quando o nome do atributo eh nulo.
	 */
	@Test(expected=NullPointerException.class)
	...
	/**
	 * Metodo que testa o comportamento de atualizaAtributo quando o nome do atributo eh vazio.
	 */
	@Test(expected=IllegalArgumentException.class)
	...
	/**
	 * Metodo que testa o comportamento de atualizaAtributo quando o nome do atributo eh invalido.
	 */
	@Test(expected=IllegalArgumentException.class)
	...
	/**
	 * Metodo que testa o comportamento de atualizaAtributo quando o valor do atributo eh nulo.
	 */
	@Test(expected=NullPointerException.class)
	...
	/**
	 * Metodo que testa o comportamento de atualizaAtributo quando o valor do atributo eh vazio.
	 */
	@Test(expected=IllegalArgumentException.class)
	...
	/**
	 * Metodo que testa o comportamento de atualizaAtributo quando o numero de faixas do atributo nao eh um inteiro.
	 */
	@Test(expected=IllegalArgumentException.class)
